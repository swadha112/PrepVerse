...
export default function InterviewCoach() {
 ...
 <p className="coach-subtitle">Practice with AI‑powered feedback and improve your interview skills</p>
 </div>
 ...
 <button className="ic-btn ic-back" onClick={backToCategories}>← Back</button>
 {!recording ? (
 ...
 <button className="ic-btn ic-calibrate" onClick={calibrateEye}>Calibrate Eye‑Contact</button>
 </div>
 ...
 <div className="ic-tip-sub">{recording ? "Listening…" : "Stopped. Review will be generated."}</div>
 ...
 <div className="ic-chip">Eye‑contact {calibrated ? `${metrics.eyeContact}%` : "0%"}</div>
